...
pytest_paths["schedules-v2"]='misttests/integration/api/main/v2/test_schedules_controller.py'
pytest_paths["rules-v2"]='misttests/integration/api/main/v2/test_rules_controller.py'
