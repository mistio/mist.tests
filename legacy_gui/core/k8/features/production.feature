...
Feature: Production
  ...
  Scenario: Production monitor and graph testing
    ...
    When I ensure "Azure" cloud is enabled
    When I visit the Machines page after the counter has loaded
    Then I search for the "k8testingmachine1" Machine
    When I click the button "k8testingmachine1"
  ...
  Scenario: Production machine reboot testing
    ...
    Then I wait for the links in homepage to appear
    When I visit the Machines page after the counter has loaded
    Then I search for the "k8testingmachine2" Machine
    When I choose the "k8testingmachine2" machine
    ...
    Then "k8testingmachine2" machine state should be "running" within 200 seconds
