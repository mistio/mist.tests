...
def delete_emails(context):
    g = gmail.login(safe_get_var('accounts/gmail_thingirl', 'gmail_thingirl_user', context.mist_config['GMAIL_FATBOY_USER']),
                    safe_get_var('accounts/gmail_thingirl', 'gmail_thingirl_password', context.mist_config['GMAIL_FATBOY_PASSWORD']))
