...
Feature: Actions for Keys
  ...
  Scenario: Add Key
    ...
    When I set the value "Test-Key" to field "Name" in "key" add form
    ...
    When I visit the Keys page
    Then "Test-Key" key should be present within 15 seconds
 ...
 @key-search
  Scenario: Filter a key
    ...
    Then "" key should be absent within 15 seconds
  ...
  Scenario: Delete Key
    ...
    And I select list item "Test-Key" key
    ...
    Then "Test-Key" key should be absent within 15 seconds
