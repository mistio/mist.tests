...
#    Then "TestScheduler" schedule should be present within 3 seconds
  ...
  Scenario: Check machine's state
    When I visit the Machines page
    Then "test-ui-machine-random" machine state has to be "stopped" within 100 seconds
    Then "test-ui-machine-2-random" machine state has to be "stopped" within 100 seconds
