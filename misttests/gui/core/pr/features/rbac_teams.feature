...
Feature: Rbac
  ...
  Scenario: Add member1
    ...
    Then I logout
    Then I should receive an email at the address "MEMBER1_EMAIL" with subject "[mist.io] Confirm your invitation" within 240 seconds
  ...
  @add-member2
   Scenario: Add member2
    ...
    Then I logout
    Then I should receive an email at the address "MEMBER2_EMAIL" with subject "[mist.io] Confirm your invitation" within 240 seconds
    And I follow the link inside the email
