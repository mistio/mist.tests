...
Feature: Login Scenarios and Api Token
  ...
  Scenario: Sign Up success and verify that user can create resources
    ...
    Then I should receive an email at the address "EMAIL" with subject "[mist.io] Confirm your registration" within 240 seconds
...
#    Then I wait for the links in homepage to appear
  ...
  Scenario: Forgot password
    ...
    Then I should receive an email at the address "EMAIL" with subject "[mist.io] Password reset request" within 240 seconds
    When I follow the link inside the email
