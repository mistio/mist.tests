...
Feature: Schedulers
  ...
  Scenario: Check machine's state
    When I visit the Machines page
    Then "test-machine-random" machine state has to be "stopped" within 240 seconds
  ...
  Scenario: Check machine's state
    When I visit the Machines page
    Then "test-machine-random" machine state has to be "running" within 240 seconds
