...
def test_list_machines_wrong_cloud_id(pretty_print, mist_core, new_owner_api_token):
    response = mist_core.list_machines(cloud_id='dummy', api_token=new_owner_api_token).get()
...
def test_create_machine_wrong_cloud_id(pretty_print, mist_core, new_owner_api_token):
    response = mist_core.create_machine(cloud_id='dummy', key_id='', api_token=new_owner_api_token,
                                        name='', provider='', location='',
                                        image='dummy', size='',).post()
    assert_response_not_found(response)
    print("Success!!!")
...
def test_create_machine_missing_parameter(pretty_print, mist_core, new_owner_api_token):
    response = mist_core.create_machine(cloud_id='dummy', key_id='', api_token=new_owner_api_token,
                                        name='', provider='', location='',
                                        image='', size='',).post()
...
def test_destroy_machine_wrong_ids(pretty_print, mist_core, new_owner_api_token):
    response = mist_core.destroy_machine(cloud_id='dummy',api_token=new_owner_api_token,
                                         machine_id='dummy',).post()
    assert_response_not_found(response)
    print("Success!!!")
...
def test_machine_action_wrong_ids(pretty_print, mist_core, new_owner_api_token):
    response = mist_core.machine_action(cloud_id='dummy',api_token=new_owner_api_token,
                                        machine_id='dummy',).post()
    assert_response_not_found(response)
    print("Success!!!")
...
def test_associate_key_wrong_ids(pretty_print, mist_core, new_owner_api_token):
...
class TestMachinesFunctionality:
    ...
    def test_list_machines(self, pretty_print, mist_core, cache, new_owner_api_token):
        if config.LOCAL:
        ...
        response = mist_core.list_machines(cloud_id=cache.get('cloud_id', ''), api_token=new_owner_api_token).get()
        assert_response_ok(response)
        assert len(response.json()) > 0, "List machines did not return any machines"
        print("Success!!!")

    def test_create_machine(self, pretty_print, mist_core, cache, new_owner_api_token):
        response = mist_core.list_images(cloud_id=cache.get('cloud_id', ''), api_token=new_owner_api_token).get()
        assert_response_ok(response)
        ...
        response = mist_core.create_machine(cloud_id=cache.get('cloud_id', ''), api_token=new_owner_api_token,
    ...
    def test_machine_wrong_machine_id(self, pretty_print, mist_core, cache, new_owner_api_token):
        response = mist_core.machine_action(cloud_id=cache.get('cloud_id', ''), api_token=new_owner_api_token,
                                            machine_id='dummy').post()
        assert_response_not_found(response)
        print("Success!!!")

    def test_machine_wrong_action(self, pretty_print, mist_core, cache, new_owner_api_token):
        response = mist_core.machine_action(cloud_id=cache.get('cloud_id', ''), api_token=new_owner_api_token,
                                            machine_id=cache.get('machine_id', '')).post()
        assert_response_bad_request(response)
        print("Success!!!")

    def test_machine_stop_machine(self, pretty_print, mist_core, cache, new_owner_api_token):
        response = mist_core.machine_action(cloud_id=cache.get('cloud_id', ''), api_token=new_owner_api_token,
    ...
    # def test_machine_monitoring_wrong_action(self, pretty_print, mist_core, cache, new_owner_api_token):
    #     response = mist_core.machine_monitoring(cloud_id=cache.get('cloud_id', ''), api_token=new_owner_api_token,
    #                                             machine_id=cache.get('machine_id', '')).post()
    #     assert_response_bad_request(response)
    #     print "Success!!!"
    #
    # def test_machine_enable_monitoring(self, pretty_print, mist_core, cache, new_owner_api_token):
    #     response = mist_core.machine_action(cloud_id=cache.get('cloud_id', ''), api_token=new_owner_api_token,
    ...
    # def test_associate_key(self, pretty_print, mist_core, cache, private_key, new_owner_api_token):
    ...
    #                                        key_id=cache.get('key_id', ''), api_token=new_owner_api_token).put()
    #     assert_response_ok(response)
    #     print "Success!!!"

    def test_destroy_machine(self, pretty_print, mist_core, cache, new_owner_api_token):
        response = mist_core.destroy_machine(cloud_id=cache.get('cloud_id', ''), api_token=new_owner_api_token,
                                             machine_id='dummy', ).post()
        assert_response_not_found(response)
        response = mist_core.destroy_machine(cloud_id=cache.get('cloud_id', ''), api_token=new_owner_api_token,
                                             machine_id=cache.get('machine_id', ''), ).post()
