...
def test_list_keys(pretty_print, mist_core, new_owner_api_token):
    response = mist_core.list_keys(api_token=new_owner_api_token).get()
...
def test_delete_key_wrong_id(pretty_print, mist_core, new_owner_api_token):
    response = mist_core.delete_key(key_id='dummy',api_token=new_owner_api_token).delete()
...
def test_delete_multiple_keys_wrong_id(pretty_print, mist_core, new_owner_api_token):
    response = mist_core.delete_keys(key_ids=['dummy','dummy1'], api_token=new_owner_api_token).delete()
    assert_response_not_found(response)
    print("Success!!!")


def test_delete_multiple_keys_no_ids(pretty_print, mist_core, new_owner_api_token):
    response = mist_core.delete_keys(key_ids=[], api_token=new_owner_api_token).delete()
    assert_response_bad_request(response)
    print("Success!!!")


def test_delete_multiple_keys_wrong_api_token(pretty_print, mist_core, new_owner_api_token):
    response = mist_core.delete_keys(key_ids=['dummy','dummy1'], api_token='1234').delete()
    assert_response_unauthorized(response)
    print("Success!!!")


def test_rename_key_wrong_id(pretty_print, mist_core, new_owner_api_token):
    response = mist_core.edit_key('dummy_id', 'new_name', api_token=new_owner_api_token).put()
    assert_response_not_found(response)
    print("Success!!!")


def test_rename_key_wrong_api_token(pretty_print, mist_core, new_owner_api_token):
    response = mist_core.edit_key('dummy_id', 'new_name', api_token=new_owner_api_token[:-2]).put()
    assert_response_unauthorized(response)
    print("Success!!!")


def test_rename_key_missing_parameter(pretty_print, mist_core, new_owner_api_token):
    response = mist_core.edit_key('dummy_id', '', api_token=new_owner_api_token).put()
    assert_response_bad_request(response)
    print("Success!!!")


def test_set_default_key_wrong_id(pretty_print, mist_core, new_owner_api_token):
    response = mist_core.set_default_key(key_id='dummy',api_token=new_owner_api_token).post()
    assert_response_not_found(response)
    print("Success!!!")


def test_set_default_key_wrong_api_token(pretty_print, mist_core, new_owner_api_token):
...
def test_get_private_key_wrong_id(pretty_print, cache, mist_core,
                                  new_owner_api_token):
    response = mist_core.get_private_key('bla', api_token=new_owner_api_token).get()
    assert_response_not_found(response)
    print("Success!!!")
...
class TestSimpleUserKeyCycle:
    def test_add_key(self, pretty_print, cache, mist_core, new_owner_api_token,
                     private_key):
        response = mist_core.list_keys(api_token=new_owner_api_token).get()
        assert_response_ok(response)
        assert len(response.json()) == 0
    ...
    def test_add_key_duplicate_name(self, pretty_print, cache, mist_core,
                                    new_owner_api_token, private_key):
        response = mist_core.add_key(
            name='TestKey',
            private=private_key,
            api_token=new_owner_api_token).put()
    ...
    def test_generate_key(self, pretty_print, cache, mist_core, new_owner_api_token):
        response = mist_core.generate_keypair(api_token=new_owner_api_token).post()
        assert_response_ok(response)
    ...
    def test_get_private_key(self, pretty_print, private_key, cache, mist_core, new_owner_api_token):
    ...
    def test_delete_key(self, pretty_print, cache, mist_core, new_owner_api_token):
        response = mist_core.delete_key(key_id=cache.get('key_id', ''),
                                        api_token=new_owner_api_token).delete()
        assert_response_ok(response)
        response = mist_core.delete_key(key_id=cache.get('key_id', ''),
                                        api_token=new_owner_api_token).delete()
        assert_response_not_found(response)
    ...
    def test_set_default_key(self, pretty_print, cache, mist_core, new_owner_api_token,
                             private_key):
        response = mist_core.add_key(
            name='TestKey2',
            private=private_key,
