...
def test_list_networks_wrong_cloud_id(pretty_print, mist_core, new_owner_api_token):
    response = mist_core.list_networks(api_token=new_owner_api_token,
                                       cloud_id='dummy').get()
...
def test_list_subnets_wrong_cloud_id(pretty_print, mist_core, new_owner_api_token):
    response = mist_core.list_subnets(api_token=new_owner_api_token,
...
def test_create_network_missing_parameter(pretty_print, mist_core, new_owner_api_token):
    response = mist_core.create_network(api_token=new_owner_api_token,
                                        cloud_id='dummy').post()
...
def test_create_network_wrong_cloud_id(pretty_print, mist_core, new_owner_api_token):
     response = mist_core.create_network(api_token=new_owner_api_token, network_params={'network': {'cidr': '10.1.0.0/16'}},
                                         cloud_id='dummy').post()
     assert_response_not_found(response)
     print("Success!!!")
...
def test_create_subnet_wrong_cloud_id(pretty_print, mist_core, new_owner_api_token):
    response = mist_core.create_subnet(api_token=new_owner_api_token,
...
def test_delete_network_wrong_cloud_id(pretty_print, mist_core, new_owner_api_token):
    response = mist_core.delete_network(api_token=new_owner_api_token,
                                       cloud_id='dummy', network_id='dummy').delete()
    assert_response_not_found(response)
    print("Success!!!")


def test_delete_subnet_wrong_api_token(pretty_print, mist_core, new_owner_api_token):
...
def test_delete_subnet_wrong_cloud_id(pretty_print, mist_core, new_owner_api_token):
    response = mist_core.delete_subnet(api_token=new_owner_api_token, network_id='dummy',
                                       cloud_id='dummy', subnet_id='dummy').delete()
    assert_response_not_found(response)
    print("Success!!!")
...
class TestNetworksFunctionality:
    ...
    def test_create_network_ec2(self, mist_core, cache, new_owner_api_token, network_valid_cidr):
    ...
    def test_create_subnet(self, mist_core, cache, new_owner_api_token, network_valid_cidr, availability_zone):
        response = mist_core.create_subnet(api_token=new_owner_api_token,
    ...
    def test_delete_subnet(self, mist_core, cache, new_owner_api_token):
        response = mist_core.delete_subnet(api_token=new_owner_api_token,
                                           network_id=cache.get('network_ids/ec2', ''),
    ...
    def test_delete_network(self, mist_core, cache, new_owner_api_token):
        response = mist_core.delete_network(api_token=new_owner_api_token,
                                            network_id=cache.get('network_ids/ec2', ''),
                                            cloud_id=cache.get('cloud_ids/ec2', '')).delete()
        assert_response_ok(response)
