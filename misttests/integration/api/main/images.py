...
def test_list_images_wrong_api_token(pretty_print, mist_core, cache, new_owner_api_token):
    response = mist_core.list_images(cloud_id=cache.get('cloud_id', ''), api_token=new_owner_api_token + 'dummy').get()
...
def test_list_images_wrong_cloud_id(pretty_print, mist_core, new_owner_api_token):
    response = mist_core.list_images(cloud_id='dummy', api_token=new_owner_api_token).get()
...
def test_star_image_wrong_api_token(pretty_print, mist_core, cache, new_owner_api_token):
    response = mist_core.star_image(cloud_id=cache.get('cloud_id', ''), image_id=cache.get('image_id', ''),
                                    api_token=new_owner_api_token + 'dummy').post()
    assert_response_unauthorized(response)
    print("Success!!!")


def test_star_image_ok(pretty_print, mist_core, cache, new_owner_api_token):
    response = mist_core.list_images(cloud_id=cache.get('cloud_id',''), api_token=new_owner_api_token).get()
    assert_response_ok(response)
