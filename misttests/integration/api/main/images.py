...
def test_list_images_wrong_api_token(pretty_print, mist_core, cache, owner_api_token):
    response = mist_core.list_images(cloud_id=cache.get('cloud_id', ''), api_token=owner_api_token + 'dummy').get()
...
def test_list_images_wrong_cloud_id(pretty_print, mist_core, owner_api_token):
    response = mist_core.list_images(cloud_id='dummy', api_token=owner_api_token).get()
