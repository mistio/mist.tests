...
def test_add_template_missing_parameter(pretty_print, mist_core,
                                        owner_api_token):
...
def test_add_template_wrong_api_token(pretty_print, mist_core,
                                      owner_api_token):
...
def test_edit_template_wrong_api_token(pretty_print, mist_core,
                                       owner_api_token):
    bad_api_token = '00' + owner_api_token[:-2]
    response = mist_core.edit_template(template_id='dummy', name='test',
...
def test_edit_template_missing_parameter(pretty_print, mist_core,
                                         owner_api_token):
    response = mist_core.edit_template(template_id='dummy', name='test',
                                       api_token=owner_api_token).put()
    assert_response_not_found(response)
...
def test_delete_template_wrong_id(pretty_print, mist_core, owner_api_token):
    response = mist_core.delete_template(
...
def test_delete_template_wrong_api_token(pretty_print, mist_core,
                                         owner_api_token):
    response = mist_core.delete_template(
...
def test_show_template_wrong_api_token(pretty_print, mist_core,
                                       owner_api_token):
    response = mist_core.show_template(
...
def test_create_stack_wrong_template_id(pretty_print, mist_core,
                                        owner_api_token):
...
def test_create_stack_wrong_api_token(pretty_print, mist_core,
                                      owner_api_token):
    bad_api_token = '00' + owner_api_token[:-2]
    response = mist_core.create_stack(api_token=bad_api_token, name='test',
                                      template_id='dummy').post()
    assert_response_unauthorized(response)
    print("Success!!!")
...
def test_delete_stack_wrong_api_token(pretty_print, mist_core,
                                      owner_api_token):
    response = mist_core.delete_stack(
...
def test_run_workflow_wrong_api_token(pretty_print, mist_core,
                                      owner_api_token):
...
class TestOrchestrationFunctionality:
    ...
    def test_add_template_missing_parameter(self, pretty_print, mist_core,
                                            owner_api_token):
        response = mist_core.add_template(
    ...
    def test_add_template_ok(self, pretty_print, mist_core, owner_api_token,
    ...
    def test_add_template_conflict(self, pretty_print, mist_core,
    ...
    def test_edit_template_missing_param(self, pretty_print, mist_core,
                                         owner_api_token, cache):
    ...
    def test_edit_template_ok(self, pretty_print, mist_core,
                              owner_api_token, cache):
    ...
    def test_delete_template_ok(self, pretty_print, mist_core,
                                owner_api_token, cache):
    ...
    def test_show_template(self, pretty_print, mist_core,
                           owner_api_token, cache):
        response = mist_core.show_template(
            api_token=owner_api_token,
