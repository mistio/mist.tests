...
@step('I select the "{option_to_select}" radio button in the "{resource_type}" add form')
...
@step('I select the "{option_to_select}" checkbox in the "{resource_type}" add form')
