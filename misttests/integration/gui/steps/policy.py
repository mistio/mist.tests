...
def add_new_rule(context, operator, rtype='all', raction='all', rid='',
    ...
    if constraints:            
        ...
        mist_form = content_div_shadow.find_element(By.TAG_NAME, 'mist-form')
        ...
        if constraints == "kevin\'s":
            ...
            size_constraint_toggle = size_constraint_subform_shadow.find_element(By.TAG_NAME, 'paper-toggle-button')
            ...
            primary_disk_checkbox = primary_disk_constraint_subform_shadow.find_element(By.TAG_NAME, 'mist-form-checkbox')
            ...
            swap_disk_checkbox = swap_disk_constraint_subform_shadow.find_element(By.TAG_NAME, 'mist-form-checkbox')
            ...
            field_constraint_toggle = field_constraint_subform_shadow.find_element(By.TAG_NAME, 'paper-toggle-button')
            ...
            field_constraint_add_button = field_constraint_container_shadow.find_element(By.TAG_NAME, 'paper-button')
            clicketi_click(context, field_constraint_add_button)
            sleep(1)
            new_field_constraint = field_constraint_container_shadow.find_element(By.TAG_NAME, 'mist-form-row')
            new_field_constraint_shadow = expand_shadow_root(context, new_field_constraint)
            mist_form_text = new_field_constraint_shadow.find_element(By.TAG_NAME, 'mist-form-text-field')
            mist_form_text_shadow = expand_shadow_root(context, mist_form_text)
            field_name_paper_input = mist_form_text_shadow.find_element(By.TAG_NAME, 'paper-input')
            field_name_paper_input_shadow = expand_shadow_root(context, field_name_paper_input)
            field_name_iron_input = field_name_paper_input_shadow.find_element(By.TAG_NAME, 'iron-input')
            field_name_input = field_name_iron_input.find_element(By.TAG_NAME, 'input')
        ...
        if constraints == "expiration":
            ...
            expiration_constraint_toggle = expiration_constraint_subform_shadow.find_element(By.TAG_NAME, 'paper-toggle-button')
            ...
            default_duration_paper_input = default_duration_field_mist_form_shadow.find_element(By.TAG_NAME, 'paper-input')
            default_duration_paper_input_shadow = expand_shadow_root(context, default_duration_paper_input)
            default_duration_iron_input = default_duration_paper_input_shadow.find_element(By.TAG_NAME, 'iron-input')
            default_duration_input = default_duration_iron_input.find_element(By.TAG_NAME, 'input')
            default_duration_input.send_keys('12')
            sleep(0.5)
            default_paper_dropdown_menu = default_duration_field_mist_form_shadow.find_element(By.TAG_NAME, 'paper-dropdown-menu')
            ...
            max_duration_paper_input = max_duration_field_mist_form_shadow.find_element(By.TAG_NAME, 'paper-input')
            max_duration_paper_input_shadow = expand_shadow_root(context, max_duration_paper_input)
            max_duration_iron_input = max_duration_paper_input_shadow.find_element(By.TAG_NAME, 'iron-input')
            max_duration_input = max_duration_iron_input.find_element(By.TAG_NAME, 'input')
            max_duration_input.send_keys('1')
            sleep(0.5)
            max_paper_dropdown_menu = max_duration_field_mist_form_shadow.find_element(By.TAG_NAME, 'paper-dropdown-menu')
            ...
            sleep(1)
            actions_drowdown = expiration_actions_subform_shadow.find_element(By.TAG_NAME, 'mist-form-dropdown')
            actions_drowdown_shadow = expand_shadow_root(context, actions_drowdown)
            actions_paper_dropdown = actions_drowdown_shadow.find_element(By.TAG_NAME, 'paper-dropdown-menu')
            ...
            expiration_notify_paper_input = notify_subform_shadow.find_element(By.TAG_NAME, 'paper-input')
            expiration_notify_paper_input_shadow = expand_shadow_root(context, expiration_notify_paper_input)
            expiration_notify_input = expiration_notify_paper_input_shadow.find_element(By.TAG_NAME, 'input')
            expiration_notify_input.send_keys(1)
            sleep(0.5)
            expiration_notify_dropdown_menu = notify_subform_shadow.find_element(By.TAG_NAME, 'paper-dropdown-menu')
            ...
            sleep(0.5)
            require_checkbox_container = expiration_notify_subform_shadow.find_element(By.TAG_NAME, 'mist-form-checkbox')
            require_checkbox_container_shadow = expand_shadow_root(context, require_checkbox_container)
            require_checkbox = require_checkbox_container_shadow.find_element(By.TAG_NAME, 'paper-checkbox')
        ...
        if constraints == "allowed DO VSPHERE":
            ...
            size_constraint_toggle = size_constraint_div.find_element(By.TAG_NAME, 'paper-toggle-button')
            clicketi_click(context, size_constraint_toggle)
            sleep(1)
            allowed_size_element = size_constraint_div.find_element(By.TAG_NAME, 'size-element')
            allowed_size_element_shadow = expand_shadow_root(context, allowed_size_element)
            add_allowed_button = allowed_size_element_shadow.find_element(By.TAG_NAME, 'paper-button')
            for i in range(4):
            ...
            for dropdown in allowed_dropdowns:
                ...
                if counter < 2:
                    size_field_dropdown = size_field_shadow.find_element(By.TAG_NAME, 'paper-dropdown-menu')
                    ...
                    for paper_slider in paper_sliders:
                        ...
                        paper_input = paper_slider_shadow.find_element(By.TAG_NAME, 'paper-input')
                        paper_input_shadow = expand_shadow_root(context, paper_input)
                        size_input = paper_input_shadow.find_element(By.TAG_NAME, 'input')
                        ...
                        sleep(1)
                        slider_counter += 1
                    # size_name_paper_input = size_field_shadow.find_element(By.TAG_NAME, 'paper-input')
                    # size_name_paper_input_shadow = expand_shadow_root(context, size_name_paper_input)
                    # human_friendly_input = size_name_paper_input_shadow.find_element(By.TAG_NAME, 'input')
