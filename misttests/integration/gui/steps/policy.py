...
def add_new_rule(context, operator, rtype='all', raction='all', rid='',
    ...
    if constraints:            
        ...
        if constraints == "kevin\'s":
            size_constraint_subform = mist_form_shadow.find_element_by_id('size_constraint_container')
            size_constraint_subform_shadow = expand_shadow_root(context, size_constraint_subform)
            size_constraint_toggle = size_constraint_subform_shadow.find_element_by_tag_name('paper-toggle-button')
            clicketi_click(context, size_constraint_toggle)
            sleep(1)
            primary_disk_constraint_subform = size_constraint_subform_shadow.find_element_by_id('primary_disk_constraint')
            primary_disk_constraint_subform_shadow = expand_shadow_root(context, primary_disk_constraint_subform)
            primary_disk_checkbox = primary_disk_constraint_subform_shadow.find_element_by_tag_name('mist-form-checkbox')
            clicketi_click(context, primary_disk_checkbox)
            sleep(1)
            swap_disk_constraint_subform =  size_constraint_subform_shadow.find_element_by_id('swap_disk_constraint')
            swap_disk_constraint_subform_shadow = expand_shadow_root(context, swap_disk_constraint_subform)
            swap_disk_checkbox = swap_disk_constraint_subform_shadow.find_element_by_tag_name('mist-form-checkbox')
            clicketi_click(context, swap_disk_checkbox)
            sleep(1)
            field_constraint_subform = mist_form_shadow.find_element_by_id('field_constraint_container')
            field_constraint_subform_shadow = expand_shadow_root(context, field_constraint_subform)
            field_constraint_toggle = field_constraint_subform_shadow.find_element_by_tag_name('paper-toggle-button')
            clicketi_click(context, field_constraint_toggle)
            sleep(1)
            field_constraint_container = field_constraint_subform_shadow.find_element_by_id('field')
            field_constraint_container_shadow = expand_shadow_root(context, field_constraint_container)
            field_constraint_add_button = field_constraint_container_shadow.find_element_by_tag_name('paper-button')
            clicketi_click(context, field_constraint_add_button)
            sleep(1)
            new_field_constraint = field_constraint_container_shadow.find_element_by_tag_name('mist-form-row')
            new_field_constraint_shadow = expand_shadow_root(context, new_field_constraint)
            mist_form_text = new_field_constraint_shadow.find_element_by_tag_name('mist-form-text-field')
            mist_form_text_shadow = expand_shadow_root(context, mist_form_text)
            field_name_paper_input = mist_form_text_shadow.find_element_by_tag_name('paper-input')
            ...
            sleep(1)
            show_checkbox = new_field_constraint_shadow.find_element_by_id('show')
            clicketi_click(context, show_checkbox)
            sleep(1)
        if constraints == "expiration":
            expiration_constraint_subform = mist_form_shadow.find_element_by_id('expiration_constraint_container')
            expiration_constraint_subform_shadow = expand_shadow_root(context, expiration_constraint_subform)
            expiration_constraint_toggle = expiration_constraint_subform_shadow.find_element_by_tag_name('paper-toggle-button')
            clicketi_click(context, expiration_constraint_toggle)
            sleep(1)
            default_duration_field_mist_form = expiration_constraint_subform_shadow.find_element_by_id('default')
            ...
            sleep(1)
            max_duration_field_mist_form = expiration_constraint_subform_shadow.find_element_by_id('max')
            ...
            sleep(1)
            expiration_actions_subform = expiration_constraint_subform_shadow.find_element_by_id('expiration_actions')
            expiration_actions_subform_shadow = expand_shadow_root(context, expiration_actions_subform)
            checkbox_group = expiration_actions_subform_shadow.find_element_by_id('available')
            ...
            expiration_notify_paper_input = notify_subform_shadow.find_element_by_tag_name('paper-input')
            ...
            sleep(0.5)
            expiration_notify_dropdown_menu = notify_subform_shadow.find_element_by_tag_name('paper-dropdown-menu')
            ...
            sleep(0.5)
            require_checkbox_container = expiration_notify_subform_shadow.find_element_by_tag_name('mist-form-checkbox')
            require_checkbox_container_shadow = expand_shadow_root(context, require_checkbox_container)
            require_checkbox = require_checkbox_container_shadow.find_element_by_tag_name('paper-checkbox')
