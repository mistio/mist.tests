...
#    And I ensure that the "image" has the tags "second:tag"
  ...
  Scenario: Add Network without specifying subnets
    ...
    And I wait for 2 seconds
    Then I should see a(n) "request" log entry of action "create_network" added "a few seconds ago" in the "network" page within 10 seconds
    Then I should see a(n) "observation" log entry of action "create_network" added "a few seconds ago" in the "network" page within 10 seconds
